...
public class LUtils {
    ...
    public static String customTagPrefix = "MobileOA";  // 自定义Tag的前缀，可以是作者名
    ...
    private static String generateTag(StackTraceElement caller) {
        ...
        tag = String.format(Locale.ENGLISH, tag, callerClazzName, caller.getMethodName(), caller.getLineNumber()); // 替换
