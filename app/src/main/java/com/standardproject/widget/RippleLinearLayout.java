	...
	public RippleLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		 init();
	        ...
	        mRippleColor = a.getColor(R.styleable.RippleView_mrippleColor,
	                mRippleColor);
	 ...
	 public void init() {
	    ...
	    public boolean onTouchEvent(final MotionEvent event) {
			...
			if (event.getActionMasked() == MotionEvent.ACTION_DOWN
				...
				mRadiusAnimator = ObjectAnimator.ofFloat(this, "radius", 0, dp(40))
						.setDuration(400);
				mRadiusAnimator
				...
				mRadiusAnimator = ObjectAnimator.ofFloat(this, "radius", dp(40),
						targetRadius);
				...
				mRadiusAnimator.addListener(new Animator.AnimatorListener() {
					...
					public void onAnimationEnd(Animator animator) {
						setRadius(0);
						ViewHelper.setAlpha(RippleLinearLayout.this, 1);
						mIsAnimating = false;
					}
			...
			} else if (event.getActionMasked() == MotionEvent.ACTION_CANCEL && this.isEnabled()) {
				mDownX = event.getX();
				mDownY = event.getY();
