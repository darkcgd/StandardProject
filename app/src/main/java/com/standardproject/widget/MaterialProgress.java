...
public class MaterialProgress extends View {
    private static final String TAG = MaterialProgress.class.getSimpleName();
    ...
    /**
     * The constructor for the MaterialProgress
     *
     * @param context
     * @param attrs
     */
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.MaterialProgress_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MaterialProgress_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MaterialProgress_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MaterialProgress_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.MaterialProgress_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.MaterialProgress_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MaterialProgress_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.MaterialProgress_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.MaterialProgress_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.MaterialProgress_matProg_progressIndeterminate, false)) {
            spin();
        }
