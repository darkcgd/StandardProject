 ...
 * <p></p>
 * 濡傛湁浠讳綍鎰忚鍜屽缓璁彲閭欢  bmme@vip.qq.com
 */
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    /**
     * 鍖归厤涓や釜Rect鐨勫叡鍚岄儴鍒嗚緭鍑哄埌out锛岃嫢鏃犲叡鍚岄儴鍒嗗垯杈撳嚭0锛?0锛?0锛?0
     */
    ...
    /**
     * 鍦≒hotoView鍐呴儴杩樻病鏈夊浘鐗囩殑鏃跺?欏悓鏍峰彲浠ヨ皟鐢ㄨ鏂规硶
     * <p></p>
     * 姝ゆ椂骞朵笉浼氭挱鏀惧姩鐢伙紝褰撶粰PhotoView璁剧疆鍥剧墖鍚庝細鑷姩鎾斁鍔ㄧ敾銆?
     * <p></p>
     * 鑻ョ瓑寰呮椂闂磋繃闀夸篃娌℃湁缁欐帶浠惰缃浘鐗囷紝鍒欎細蹇界暐璇ュ姩鐢伙紝鑻ヨ鍐嶆鎾斁鍔ㄧ敾鍒欓渶瑕侀噸鏂拌皟鐢ㄨ鏂规硶
     * (绛夊緟鐨勬椂闂撮粯璁?500姣锛屽彲浠ラ?氳繃setMaxAnimFromWaiteTime(int)璁剧疆鏈?澶х瓑寰呮椂闂?)
     */
