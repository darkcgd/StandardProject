 ...
 *
 */
public class ChangeCityActivity extends AbActivity implements OnClickListener {
	...
	private void getCityList() {
		...
		String url = Config.getApi("/common/getAllCityList");//请求地址
		// 绑定参数
		AbRequestParams params = new AbRequestParams();

		//type(类型,1-国家，2-省份，3-城市，4-县)
		params.put("", "");
		...
		TheApp.mAbHttpUtil.post(url,params, new AbStringHttpResponseListener() {
			...
			public void onSuccess(int statusCode, String content) {
				...
				if (success) {
					...
					AbToastUtil.showToast(ChangeCityActivity.this, "获取失败!");
				}
