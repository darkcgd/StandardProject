...
package com.ugiant.http.entity;
...
import com.ugiant.http.AbHttpResponseListener;
import com.ugiant.http.entity.mine.content.ContentBody;
import com.ugiant.http.entity.mine.content.WriteByteListener;
...
public class HttpMultipart {
    ...
    private void doWriteTo(
        ...
        for (FormBodyPart part: this.parts) {
            ...
            if (writeContent) {
                part.getBody().writeTo(out,new WriteByteListener() {
					
					@Override
					public void onWritten(long bytesWritten, long totalSize) {
						updateProgress(bytesWritten,totalSize);
					}
				});
     ...
     * @param totalSize
     */
    private void updateProgress(long bytesWritten, long totalSize) {
    	if(responseListener!=null){
    		responseListener.sendProgressMessage(bytesWritten, totalSize);
    	}
    }

	public AbHttpResponseListener getResponseListener() {
		return responseListener;
	}

	public void setResponseListener(AbHttpResponseListener responseListener) {
