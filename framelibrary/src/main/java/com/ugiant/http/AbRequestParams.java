...
import com.ugiant.http.entity.mine.content.ByteArrayBody;
import com.ugiant.http.entity.mine.content.ContentBody;
import com.ugiant.http.entity.mine.content.FileBody;
...
public class AbRequestParams {
	 ...
	 * @param str
	 */
	public void put(String attr, Integer[] value) {
		try {
			if (attr != null && value != null) {
				urlParams.put(attr, new Gson().toJson(value));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
