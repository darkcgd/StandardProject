...
/**
 * © 2012 amsoft.cn
 * 名称：AbCharacterParser.java
 * 描述：汉字转换为拼音.
 *
 * @author cgd
 * @date 2016-01-11
 */
public class AbCharacterParser {
	...
	private static AbCharacterParser characterParser = new AbCharacterParser();

	/**
	 * Gets the single instance of AbCharacterParser.
	 *
	 * @return single instance of AbCharacterParser
	 */
	public static AbCharacterParser getInstance() {
