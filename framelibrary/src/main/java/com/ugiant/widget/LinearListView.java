...
public class LinearListView extends IcsLinearLayout {
	...
	/**
	 * @return The callback to be invoked with an item in this LinearListView
	 *         has been clicked, or null id no callback has been set.
	 */
	...
	/**
	 * When the current adapter is empty, the LinearListView can display a
	 * special view call the empty view. The empty view is used to provide
	 * feedback to the user that no data is available in this LinearListView.
	 * 
	 ...
	 * sure that the layout is VISIBLE and that the empty view is GONE (if it's
	 * not null).
	 */
