...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            mGravity = a.getInt(R.styleable.wheelview_gravity_yn, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.wheelview_textColorOut_yn, textColorOut);
            textColorCenter = a.getColor(R.styleable.wheelview_textColorCenter_yn,textColorCenter);
            dividerColor = a.getColor(R.styleable.wheelview_dividerColor_yn,dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_textSize_yn,textSize);
        }
